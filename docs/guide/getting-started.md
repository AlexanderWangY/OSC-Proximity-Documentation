...
The documentation for this project is hosted through [Vitepress](https://vitepress.dev/) pulling content from [Alex's repo](https://github.com/AlexanderWangY/OSC-Proximity-Documentation). So to work on this issue, you will have to create a fork of Alex's repo and make changes locally before you create a PR. 
...
For example, Aadit has created a branch called `add-tutorial` on his fork to create a frontend tutorial that would resolve the issue. 
